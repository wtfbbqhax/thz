...
ifeq ($(PLATFORM),mingw32)
  ...
  BASE_CFLAGS = -Wall -fno-strict-aliasing -Wimplicit -Wstrict-prototypes -I/usr/i686-mingw32/usr/include -I/usr/i686-mingw32/directx/include -L/usr/i686-mingw32/usr/lib -L/usr/i686-mingw32/directx/lib
