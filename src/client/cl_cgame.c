...
*/
	...
	case CG_UPDATE_PITCH:
		CL_UpdatePitch( VMA(1) );
		return 0;
...
void CL_UpdateYaw( float *f )
{
//	Com_printf("Got update yaw msg\n");
        //Com_Printf ("yaw %f  +=  %f\n", cl.viewangles[0], f);
	cl.viewangles[0] += *f;
}

void CL_UpdatePitch( float *f )
{

	//Com_Printf ("pitch %f  +=  %f\n", cl.viewangles[1], f);
//	Com_printF("Got update pitch msg\n");
        cl.viewangles[1] += *f;
}
