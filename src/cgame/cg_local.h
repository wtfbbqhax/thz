...
typedef struct aimVec_s {
        vec3_t ofs;
        struct aimVec_s *next;
} aimVec_t;
...
typedef struct
{
  ...
  centity_t   *entHumanClients[ MAX_CLIENTS ];
  centity_t   *entAlienClients[ MAX_CLIENTS ];
...
//THZ cvars
extern	vmCvar_t    thz_bobbing;
extern  vmCvar_t    thz_norecoil;
extern  vmCvar_t    thz_walls;
extern  vmCvar_t    thz_healthbar;
extern  vmCvar_t    thz_scanner;
extern  vmCvar_t    thz_showhp;
extern  vmCvar_t    thz_radar;
extern  vmCvar_t    thz_fov;
extern  vmCvar_t    thz_radarWidth;
extern  vmCvar_t    thz_radarHeight;
extern  vmCvar_t    thz_radarX;
extern  vmCvar_t    thz_radarY;

extern  vmCvar_t    thz_xhairs;
extern  vmCvar_t    thz_radarrange;
extern  entityPos_t  entityPositions;

extern  vmCvar_t    thz_glow;
extern  vmCvar_t    thz_aimmode; //0 = off, 1 = alien, 2 = human
extern  vmCvar_t    thz_aimthru; //0 = no, 1 = yes
extern  vmCvar_t    thz_esp; // 0 = off, 1 = on
...
extern  vmCvar_t	thz_playerbarheight; //default 2.5f
extern  vmCvar_t	thz_playerbarwidth; //default 25.0f
...
char		CG_GetColorCharForClient( int clientnum );

extern centity_t *target;
...
extern int    true_angles;
extern float *float_angles;
extern int    lastent;

void CG_UpdateEntityPositions( void );

void trap_SetYaw(float *f);
void trap_SetPitch(float *f);
